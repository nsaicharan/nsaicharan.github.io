    ...
    $.BigVideo = function(options) {
		...
		BigVideo.init = function() {
			if (!isInitialized) {
				...
				player = $('<video id="'+vidEl.substr(1)+'" class="video-js vjs-default-skin" preload="auto" data-setup="{}" '+autoPlayString+' webkit-playsinline poster="https://davebushmarketing.com/images/bg_clouds.jpg"></video>');
